export let cart=JSON.parse(localStorage.getItem('cart'));//to store on a local storage 
...
export function saveToStorage(){
    localStorage.setItem('cart',JSON.stringify(cart));//to save on local storage
}
